...
public class Player {
	 ...
	 * @param deckFileName - location of deck file
	 * @param game - pointer to Game object that the Player is playing, 
	 * this is set to null until the Game is initialized
	 * @throws IOException
	 */
	...
	/** 
	 * Takes a card from the players deck, creates the Card associated with the string,
	 * and adds the Card object to the Players hand
	 */
	public void draw() {
	 ...
	 * Called when user inputs: print hand
	 */
	...
	/**
	 * Calls the games attack method
	 * called when user inputs: attack
	 */
	public void attack() {		
		game.attack();
	}
	...
	/** 
	 * Calls the games pass method
	 * called when user inputs: pass
	 */
	public void pass() {
		game.pass();
	...
	/** 
	 * Calls the play method of the card located at pos in hand
	 * Removes the played card from the hand
	 * called when user inputs: play #
	 * @param pos
	 * @param iStream
	 * @throws IOException
	 */
	...
	/**
	 * Calls the games homeSwitch method, which switches the positions
	 * 0 and pos in the homeField
